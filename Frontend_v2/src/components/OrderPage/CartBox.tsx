...
export default function CartBox({ cart, products, onRemove, onSubmit }: Props) {
  ...
  return (
    <div className="absolute right-8 top-24 w-80 bg-white shadow-xl rounded-2xl p-4 border z-20">
